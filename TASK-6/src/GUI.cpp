...
MyFrame1::MyFrame1( wxWindow* parent, wxWindowID id, const wxString& title, const wxPoint& pos, const wxSize& size, long style ) : wxFrame( parent, id, title, pos, size, style )
{
	...
	this->SetClientSize(this->FromDIP(wxSize(1200, 600)));
    ...
    m_scrolledWindow->SetInitialSize(wxSize(1200,600));
    ...
    rgbButton = new wxButton(this, wxID_ANY, ("sin(RGB)"), wxDefaultPosition, wxDefaultSize, 0);
    bSizer2->Add( rgbButton, wxSizerFlags(0).Center().Border(wxALL, 5));
    ...
    rgbButton->Connect(wxEVT_COMMAND_BUTTON_CLICKED, wxCommandEventHandler( MyFrame1::m_b_rgb_click ), NULL, this);
}
...
MyFrame1::~MyFrame1()
{
    ...
    rgbButton->Disconnect(wxEVT_COMMAND_BUTTON_CLICKED, wxCommandEventHandler( MyFrame1::m_b_rgb_click ), NULL, this);
}
