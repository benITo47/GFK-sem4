...
bool MyApp::OnInit() 
{
 ...
 {
  wxLogNull logNo;
  if (!image.LoadFile("/Users/bartek/Documents/Grafika Komputerowa/lab06/test.jpg"))
  {
  ...
  } else
  {
   ...
   if (!image.LoadFile("/Users/bartek/Documents/Grafika Komputerowa/lab06/mask.png"))
   {
