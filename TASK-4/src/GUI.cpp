...
MyFrame1::MyFrame1( wxWindow* parent, wxWindowID id, const wxString& title, const wxPoint& pos, const wxSize& size, long style ) : wxFrame( parent, id, title, pos, size, style )
{
    ...
    wxMarekrButton = new wxCheckBox(this, wxID_ANY, ("Pokaż markery"), wxDefaultPosition, wxDefaultSize,0);
    wxMarekrButton->SetValue(true);
    bSizer2->Add(wxMarekrButton,0,wxALIGN_CENTER|wxALL, 5);
    ...
    wxMarekrButton->Connect( wxEVT_COMMAND_CHECKBOX_CLICKED, wxCommandEventHandler( MyFrame1::wxMarekrButton_click ), NULL, this );  //moja funkcjonalnosc
