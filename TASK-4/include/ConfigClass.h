...
class ConfigClass
{
    private:
       GUIMyFrame1 *MainWindow;   // wskaznik do glownego okna aplikacji
        ...
        bool show_markers;          //dodana funkcjonalnosc - moj kod
    public:
        ...
        bool GetShowMarkers(){return show_markers;}; //dodana funkcjonalnosc - moj kod
        void SetShowMarkers(bool show){show_markers = show;}; //dodana funkcjonalnosc - moj kod
