...
class MyFrame1 : public wxFrame
{
	...
	protected:
        ...
        virtual void wxMarekrButton_click(wxCommandEvent& event){event.Skip();}
	...
	public:
		...
		MyFrame1( wxWindow* parent, wxWindowID id = wxID_ANY, const wxString& title = _("GFK Lab 04"), const wxPoint& pos = wxDefaultPosition, const wxSize& size = wxSize(800, 500), long style = wxDEFAULT_FRAME_STYLE | wxTAB_TRAVERSAL);
